...
from BecaGISTools.geocapt.topogeo import azimute, dd2dms
from BecaGISTools.geocapt.cartography import areaGauss
import os
...
class CalculatePolygonAngles(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        return self.tr('Calculate polygon angles', 'Calculate polygon angle')
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo(self.tr('Operation completed successfully!', 'Operation completed successfully!'))
