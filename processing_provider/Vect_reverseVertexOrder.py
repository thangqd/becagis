...
class ReverseVertexOrder(QgsProcessingAlgorithm):
    ...
    txt_vi = 'Inverts vertex order for polygons and lines.'
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterVectorLayer(
                self.INPUT,
                self.tr('Input Layer', 'Input Layer'),
        ...
        self.addParameter(
            QgsProcessingParameterBoolean(
                self.SELECTED,
                self.tr('Only selected', 'Only selected'),
                defaultValue=False
            )
        )
        ...
        self.addParameter(
            QgsProcessingParameterBoolean(
                self.SAVE,
                self.tr('Save Editions', 'Save Editions'),
                defaultValue=True
            )
        )
